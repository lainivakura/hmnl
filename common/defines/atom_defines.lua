...
--Navy
NDefines.NNavy.CAPITAL_SHIP_MAX_NAV_FACTORIES_PER_LINE = 50
NDefines.NNavy.CONVOY_MAX_NAV_FACTORIES_PER_LINE = 50
NDefines.NNavy.FLOATING_HARBOR_MAX_NAV_FACTORIES_PER_LINE = 50
NDefines.NNavy.DEFAULT_MAX_NAV_FACTORIES_PER_LINE = 10
